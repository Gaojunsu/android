package com.keylinks.android.api;
...
import com.keylinks.android.api.core.ARouterLoadGroup;
import com.keylinks.android.api.core.ARouterLoadPath;
       ...
       String groupClassName = context.getPackageName() + ".apt" + GROUP_FILE_PREFIX_NAME + group;
        ...
        try {
            ...
            if (pathLoad != null) {
                ...
                ARouterBean routerBean = pathLoad.loadPath().get(path);
                if (routerBean != null) {
